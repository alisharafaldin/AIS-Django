...
class EmpForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'passportExpiryDate': forms.TextInput(attrs={'class':'form-control', 'placeholder':'تاريخ إنتهاء الجواز'}),
            ...
            'enteryDate': forms.TextInput(attrs={'class':'form-control', 'placeholder':'تايخ الدخول'}),
            ...
            'iqamaReleaseDate': forms.TextInput(attrs={'class':'form-control', 'placeholder':'تاريخ الإصدار'}),
            'iqamaExpiredDate': forms.TextInput(attrs={'class':'form-control', 'placeholder':'تاريخ الإنتهاء'}),
            ...
            'workStartingDate': forms.TextInput(attrs={'class':'form-control', 'placeholder':'تاريخ بداية العمل'}),
