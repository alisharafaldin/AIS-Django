...
#     new_qayd = Qayd()
#     if request.method == 'POST' and 'btnsave' in request.POST and request.POST['debit'] and request.POST['credit'] and request.POST['desQaydDetails'] and request.POST['accID'] and request.POST['projectID'] and request.POST['empID']:
...
def qayd_add(request):
    ...
    if request.method == 'POST' and 'btnsave' in request.POST:
      new_qayd = QaydForm(request.POST)
