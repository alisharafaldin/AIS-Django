...
class InvoicesSalesBodyImportExport(ImportExportModelAdmin):
    pass
    list_display = ['id', 'inventoryID', 'itemID', 'quantity', 'unit_price', 'discount', 'total_price_before_tax', 'total_price_local_currency', 'tax_rate', 'tax_value', 'total_price_after_tax']
