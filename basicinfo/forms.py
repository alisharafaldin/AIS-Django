    ...
    class Meta:
        ...
        widgets = {
            ...
            'countryID': forms.Select(attrs={'class':'form-control', 'placeholder':'الدولة',    
                    'data-url-region': "{% url 'load_region' %}",
                    'data-url-state': "{% url 'load_state' %}",
                    'data-url-city': "{% url 'load_city' %}"}),
            'regionID': forms.Select(attrs={'class':'form-control', 'placeholder':'المنطقة', 'data-url-state': "{% url 'load_state' %}"}),
            'stateID': forms.Select(attrs={'class':'form-control', 'placeholder':'الولاية', 'data-url-city': "{% url 'load_city' %}"}),
