...
from .models import CashReceiptHead
...
@receiver(pre_save, sender=CashReceiptHead)
...
setup_delete_file_signal(CashReceiptHead, 'attachments')
setup_change_file_signal(CashReceiptHead, 'attachments')
