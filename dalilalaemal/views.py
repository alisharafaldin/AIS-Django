...
def dalilalaemal_home(request):
    ...
    return render(request, 'dalilalaemal/dalilalaemal_home.html', context)
...
def dalilalaemal_all(request):
    ...
    # عرض الصفحة مع البيانات
    return render(request, 'dalilalaemal/dalilalaemal_all.html', context)
