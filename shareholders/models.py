...
class Contracts(models.Model):
    shareholdersID = models.ForeignKey(ShareholdersInfo, verbose_name='المساهم', on_delete=models.PROTECT, blank=True, null=True) #لن يتم حزف الصنف في حالة حذف الموظف
    ...
    profitOfShare = models.IntegerField(verbose_name='ربح السهم', default=135000)
