...
class ShareholderForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'dateOfBirth': forms.TextInput(attrs={'class':'form-control', 'placeholder':'تاريخ الميلاد', 'type':'date'}),
            ...
            'id_ExpiredDate': forms.TextInput(attrs={'class':'form-control', 'placeholder':'تاريخ إنتهاء الهوية', 'type':'date'}),
