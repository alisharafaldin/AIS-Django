...
class ContractsForm(forms.ModelForm):
  class Meta:
    ...
    widgets = {
      ...
      'cycleID': forms.Select(attrs={'placeholder':'المحور','class':'form-control'}),
      ...
      'profitRate': forms.TextInput(attrs={'placeholder':'ربح السهم','class':'form-control'}),
      ...
      'witnes2ID': forms.Select(attrs={'placeholder':'الشاهد الأول','class':'form-control'}),
    }