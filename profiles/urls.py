...
urlpatterns = [  
    ...
    path('reset_password_sent/', auth_views.PasswordResetDoneView.as_view(template_name='profiles/registration/password_reset_sent.html'), name='password_reset_done'),
